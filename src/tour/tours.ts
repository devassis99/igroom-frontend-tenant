...
export const TOURS: readonly Tour[] = [
  {
    ...
    steps: [
      ...
      {
        anchor: "nav-help",
        title: "These tips are on every screen",
        body: "Each screen has its own short walkthrough, shown the first time you open it. This button brings back the one for wherever you're standing.",
        placement: "right",
        radius: 10,
      },
    ],
...

  {
    ...
    steps: [
      ...
      },
      {
        ...
        tip: "Switching them off doesn't remove them — the help button in the sidebar always brings the current screen's tips back.",
      },
    ],
  },
